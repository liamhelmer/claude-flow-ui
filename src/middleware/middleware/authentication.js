...
class AuditLogger {
    ...
    log(entry) {
        const fullEntry = Object.assign(Object.assign({}, entry), { timestamp: new Date() });
    ...
    createExpressMiddleware() {
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let user;
                try {
                    user = yield this.tokenValidator.validateAuthHeader(authHeader);
                }
                catch (authError) {
    ...
    createWebSocketMiddleware() {
        return (socket, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Validate token
                const user = yield this.tokenValidator.validateToken(token);
                // Check rate limit by user
                const userIdentifier = user.subject;
...
function createWebSocketAuthHandler(config) {
    ...
    return (token) => __awaiter(this, void 0, void 0, function* () {
        try {
            const payload = yield tokenValidator.validateToken(token);
